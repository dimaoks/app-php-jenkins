...
<body>
    <section class="congratulations">
        <h1>Hi</h1>
        <p>you is system administrator<em>PHP</em> we are cool boys and testing AWS&nbsp;Cloud</p>
    ...
    <section class="instructions">
        <h2>What's Next?</h2>
        <ul>
            <li><a href="pornohub.com">AWS Elastic Beanstalk overview</a></li>
